// Exceed CAD Academic Basketball Prep Program - Site Data

export const siteInfo = {
  name: "Exceed CAD",
  fullName: "Exceed CAD Academic Basketball Prep Program",
...
export const aboutSection = {
  title: "OUR STORY",
  description: [
    "Exceed CAD Academic Basketball Prep Program is an exceptional opportunity for young individuals from diverse backgrounds, including those with special needs, to excel both academically and athletically.",
...
export const programsDetail = {
  ...
  description: "Exceed CAD offers comprehensive programs tailored to meet every student-athlete's needs. Whether you're looking for academic support, elite basketball training, scholarship opportunities, or university preparation, you'll find everything you need right here.",
  images: [
...
export const news = [
  {
    ...
    title: "Exceed CAD Achieves 95% University Acceptance Rate",
    category: "ACADEMICS", 
    author: "ADMIN",
    date: "December 2024",
  ...
  },
  {
    ...
    title: "Exceed CAD Teams Dominate CESPORTS Championships",
    category: "BASKETBALL",
    author: "ADMIN",
    date: "October 2024", 
