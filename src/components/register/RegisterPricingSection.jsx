  ...
  return (
    <section className="py-20 px-4 sm:px-8 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto max-w-7xl">
        ...
        {/* Download Forms Section - Prominent at Top */}
        <div className="mb-16 bg-red-600 rounded-lg p-8 md:p-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              REGISTRATION FORMS
            </h2>
            <p className="text-xl text-red-100">
              Download and complete the required forms to register
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            <a
              href="/Exceed_Parent_Consent.pdf"
              download
              className="bg-white text-red-600 font-bold py-4 px-8 rounded-full hover:bg-gray-200 transition-colors flex items-center gap-3 text-lg shadow-lg"
            >
            ...
            <a
              href="/EXCEED_REGISTRATION_FORM.pdf"
              download
              className="bg-black text-white font-bold py-4 px-8 rounded-full hover:bg-gray-900 transition-colors flex items-center gap-3 text-lg border-2 border-white shadow-lg"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            ...
            <a
              href="/International Student Enrollment - Academic Pathways & Tuition Schedule.pdf"
              download
              className="bg-white text-red-600 font-bold py-4 px-8 rounded-full hover:bg-gray-200 transition-colors flex items-center gap-3 text-lg shadow-lg"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              INTERNATIONAL ENROLLMENT GUIDE
            </a>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-red-600 font-bold text-xl mb-2">MANDATORY REQUIREMENT</h3>
              <p className="text-gray-800 text-lg">
                <strong>Parent Consent Form is MANDATORY.</strong> All registrations must include a completed and signed Parent Consent Form. Registration will not be processed without this document.
              </p>
            </div>
          </div>
        </div>
...
export default RegisterPricingSection;
