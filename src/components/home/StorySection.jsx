        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 relative">
            <div className="relative overflow-hidden rounded-lg">
              <img 
                ...
                alt="EXCEED Academic Basketball Program - Our Story" 
          ...
          <div className="order-1 lg:order-2">
                ...
                <p key={index} className="text-gray-300 leading-relaxed text-lg">
                  {index === 0 && (
                    <span className="text-red-400 font-semibold">
                      EXCEED Academic Basketball Prep Program
                    </span>
                  )}
                  {index === 0 ? paragraph.replace('EXCEED Academic Basketball Prep Program', '') : paragraph}
                </p>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {[
                "Grades 6-12/Post Secondary Academic Excellence",
