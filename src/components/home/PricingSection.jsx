        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {pricingPlans.map((plan) => (
            ...
            >
              ...
              {/* Download link for International students */}
              {plan.id === 'international' && (
                <a
                  href="/International Student Enrollment - Academic Pathways & Tuition Schedule.pdf"
                  download
                  className="mt-6 flex items-center justify-center gap-2 text-red-400 hover:text-red-300 transition-colors text-sm font-semibold"
                >
