      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="grid grid-cols-2 gap-4">
          <img 
            ...
            alt="EXCEED player training" 
            className="rounded-lg w-full object-cover" 
          />
          <div className="space-y-4">
            <img 
              src="/images/training2.png" 
              alt="EXCEED basketball skills" 
              className="rounded-lg w-full h-auto object-cover" 
            />
            <img 
              src="/images/team-celebration.png" 
              alt="EXCEED team celebration" 
              className="rounded-lg w-full h-auto object-cover" 
            />
          </div>
        </div>
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Why Choose EXCEED Camps?</h2>
