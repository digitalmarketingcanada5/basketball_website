      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          <PillarCard 
            ...
            description="Every student-athlete's success starts with academic achievement. At Exceed CAD, we maintain a 75% minimum academic average while providing Individualized Education Plans (IEPs) and specialized support for diverse learning needs, ensuring both classroom and court excellence." 
          />
          <PillarCard 
            icon={<BasketballIcon />} 
          ...
          <PillarCard 
            ...
            description="Choose from three convenient Edmonton locations: BCR School, Amiskwaciy Academy, and Saint-Joseph. Each location offers full academic programs with specialized facilities, providing flexibility for families across the region." 
          />
          <PillarCard 
            icon={<CoachingIcon />} 
          ...
          <PillarCard 
            ...
            description="At Exceed CAD, every lesson, practice, and game is a step toward building something extraordinary. By focusing on academic achievement, athletic excellence, and inclusive support, we're transforming what it means to be a student-athlete." 
          />
        </div>
      </div>
    </section>
