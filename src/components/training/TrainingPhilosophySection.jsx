        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 mb-8">
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                EXCEED offers structured, <strong className="text-red-400">high-intensity training programs</strong> designed to help young athletes refine their skills, improve their game IQ, and <strong className="text-white">become the kind of player that makes an impact on the court.</strong>
              </p>
